...
HW_WIFI_FREQ_BAND = 2.4            #AP模式下的wifi频率， 直接赋值为 2.4 或 5 对应2.4G和5G
HW_WIFI_CHANNEL = 7              #AP模式下的wifi信道，5G下目前测试可用的有 149, 153, 157, 161
#HW_WIFI_STA_SSID = 'Hiwonder_5G'     #STA模式下的SSID
#HW_WIFI_STA_PASSWORD = 'hiwonder'#STA模式下的WIFI密码  
